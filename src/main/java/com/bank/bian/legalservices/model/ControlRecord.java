package com.bank.bian.legalservices.model;
...
/**
 * The BIAN control record for this service domain: "Legal Matter Advisory Session".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Provide Advice) applied
 * to its asset type (Legal Matter). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Legal Matter Advisory Session";
